...
const API_BASE = import.meta.env.VITE_API_URL || 'https://rentflatmatefinder-production.up.railway.app/api';
const WS_BASE = import.meta.env.VITE_WS_URL || 'wss://rentflatmatefinder-production.up.railway.app';
